    ...
    <div class="vm-container">
        ...
        <div class="vm-section-head">
            <div>
                ...
                <p class="text-slate-600 mt-3 max-w-2xl">Encontrá tu próximo equipo entre los modelos más buscados de Apple, Samsung, Google y Xiaomi.</p>
            </div>
        </div>
        ...
        <div class="vm-catalog-layout">
            ...
            <aside class="vm-sidebar" aria-label="Filtros">
                ...
                <div class="vm-filter-group">
                    ...
                    <input type="search" id="vm-search" class="vm-input"
                    ...
                    <?php if (!empty($resultado['data'])): ?>
                        ...
                        <?php if ($totalPages > 1):
                            $buildUrl = function($p) use ($sort, $marcas, $search) {
                                ...
                                if (!empty($marcas)) $params['marcas'] = implode(',', $marcas);
