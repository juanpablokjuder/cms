...
$headerTitle = 'Nuevo Item de Servicio';
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="page-header-left">
                    <h2 class="page-title">Nuevo Item de Servicio</h2>
                    <p class="page-subtitle">Complete el formulario para crear un nuevo item</p>
                </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:var(--space-5)">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="card-header-title">Descripción (Texto)</span>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="card-header-title">Imágenes</span>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                                <button type="submit" class="btn btn-primary btn-full" id="item-form-submit">
                                    <span class="spinner"></span><span class="btn-text">Crear Item</span>
                                </button>
