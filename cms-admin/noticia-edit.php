...
if (empty($editUuid)) { header('Location: noticias.php'); exit; }
?>
<!DOCTYPE html>
<html lang="es">
<head>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                            <div class="form-group">
                                ...
                                <input type="text" id="noticia-slug" class="form-input" placeholder="slug-de-la-noticia" maxlength="255">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="padding-bottom:var(--space-3)">
                            <div class="upload-zone noticia-upload-zone" id="noticia-upload-zone">
                                ...
                                <div class="upload-zone-text"><strong>Haga clic</strong> o arrastre imágenes para agregar</div>
