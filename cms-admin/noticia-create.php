                            ...
                            <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="noticia-slug" class="form-input"
                                        placeholder="auto-generado desde el título" maxlength="255">
                                    <span class="form-error" id="noticia-slug-error"></span>
                                    <span
                                        style="font-size:var(--font-size-xs);color:var(--color-text-tertiary);margin-top:var(--space-1);display:block">Dejar
                                        vacío para generarlo automáticamente.</span>
                                </div>
                            </div>
