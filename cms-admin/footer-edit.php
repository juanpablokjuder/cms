...
<body>
        ...
        <main class="main-content">
                ...
                <section class="footer-section card" style="margin-bottom:var(--space-5)">
                    <div class="card-header">
                        ...
                        <div class="footer-col-count-selector" role="group" aria-label="Número de columnas">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <button type="button" class="col-count-btn <?php echo $i === 3 ? 'active' : ''; ?>"
                                    data-count="<?php echo $i; ?>"><?php echo $i; ?></button>
                            <?php endfor; ?>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <section class="footer-section card" style="margin-bottom:var(--space-5)">
                    ...
                    <div class="card-body" style="padding:var(--space-4)">
                        <ul class="footer-item-list" id="redes-list">
                            <li class="footer-item-empty" id="redes-empty">Sin redes sociales. Haga clic en "Agregar
                                red".</li>
                        </ul>
                    </div>
                </section>
                    ...
                    <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                        <div class="form-group">
                            ...
                            <input type="text" id="footer-copyright" class="form-input"
                                placeholder="© 2025 Mi Empresa. Todos los derechos reservados." maxlength="500">
                        </div>
                        <div>
                            <div
            ...
            <template id="tpl-block-media-texto">
                <div class="footer-block-media-texto">
                    <div class="footer-logo-mount"></div>
                    <div class="form-group" style="margin-top:var(--space-3)">
                        <label class="form-label">Texto descriptivo</label>
                        <div class="footer-descripcion-quill"></div>
                    </div>
                </div>
            </template>
            ...
            <template id="tpl-block-contacto">
                <div class="footer-block-contacto" style="display:flex;flex-direction:column;gap:var(--space-3)">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input footer-dir-input" placeholder="Av. Principal 123, Ciudad"
                            maxlength="500">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Teléfono</label>
                        <input type="text" class="form-input footer-tel-input" placeholder="+54 11 1234-5678"
                            maxlength="100">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="email" class="form-input footer-email-input" placeholder="contacto@empresa.com"
                            maxlength="255">
                    </div>
                </div>
            </template>
            ...
            <template id="tpl-enlace-item">
                <li class="footer-enlace-item" draggable="true">
                    ...
                    <input type="text" class="form-input footer-enlace-texto" placeholder="Texto ancla" maxlength="255"
                        style="height:34px;font-size:var(--font-size-xs)">
                    <input type="text" class="form-input footer-enlace-url" placeholder="URL o /ruta" maxlength="500"
                        style="height:34px;font-size:var(--font-size-xs)">
            ...
            <template id="tpl-red-item">
                <li class="footer-red-item" draggable="true">
                    <div class="footer-red-item-header">
                        <span class="faq-item-drag-handle">⠿</span>
                        <input type="text" class="form-input footer-red-nombre" placeholder="Nombre (ej: Instagram)"
                            maxlength="100" style="height:34px;font-size:var(--font-size-xs);flex:1">
                        <input type="url" class="form-input footer-red-url" placeholder="https://..." maxlength="500"
                            style="height:34px;font-size:var(--font-size-xs);flex:2">
                    ...
                    <div class="footer-red-svg-area">
                        ...
                        <textarea class="form-input footer-red-svg" rows="3"
                            placeholder='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">...</svg>'
                            style="height:auto;padding:var(--space-2) var(--space-3);font-size:var(--font-size-xs);font-family:monospace"></textarea>
    ...
    <?php if ($isEdit): ?>
        <script>window.FOOTER_UUID = <?php echo json_encode($editUuid); ?>;</script><?php endif; ?>
