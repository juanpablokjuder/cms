...
$currentPage = 'faqs';
$headerTitle = 'Editar FAQ';
$pageTitle   = 'Editar FAQ';
$editUuid    = trim($_GET['uuid'] ?? '');
if (empty($editUuid)) { header('Location: faqs.php'); exit; }
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <main class="main-content">
        <div class="page-header">
            <div class="page-header-left">
                <h2 class="page-title">Editar Sección FAQ</h2>
                <p class="page-subtitle">Modifique el título, imagen y preguntas frecuentes</p>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 380px;gap:var(--space-5);align-items:start">
                ...
                <div style="display:flex;flex-direction:column;gap:var(--space-5)">
                    <div class="card">
                        ...
                        <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                            <div class="form-group">
                                <label class="form-label" for="faq-titulo">Título <span class="required">*</span></label>
                                <input type="text" id="faq-titulo" class="form-input" placeholder="Ej: Preguntas sobre envíos" required maxlength="255">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="upload-zone noticia-upload-zone" id="faq-upload-zone">
                                <input type="file" id="faq-image-input" accept="image/png,image/jpeg,image/webp,image/gif,image/svg+xml">
                                <div class="upload-zone-icon">🖼️</div>
                                <div class="upload-zone-text"><strong>Haga clic</strong> o arrastre para reemplazar</div>
                                <div class="upload-zone-hint">PNG, JPG, WebP, GIF, SVG · Máx. 10 MB</div>
                            </div>
                            <div class="image-preview-container" id="faq-image-preview-container">
                                <img id="faq-image-preview" class="image-preview" src="" alt="Previsualización">
                                <div class="image-preview-actions">
                                    <button type="button" class="image-preview-remove" id="faq-image-preview-remove" title="Eliminar imagen">✕</button>
                                </div>
                                <div class="image-preview-info" id="faq-image-preview-info"></div>
                            </div>
                            <div style="display:flex;flex-direction:column;gap:var(--space-3);margin-top:var(--space-3)">
                                <input type="text" id="faq-imagen-alt"   class="form-input" placeholder="Texto alternativo (alt)"  maxlength="255">
                                <input type="text" id="faq-imagen-title" class="form-input" placeholder="Título de la imagen"       maxlength="255">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <template id="faq-item-template">
            <li class="faq-item-row" draggable="true">
                <div class="faq-item-header">
                    ...
                    <button type="button" class="gallery-remove faq-item-remove" title="Eliminar pregunta">✕</button>
                </div>
                <div class="faq-item-body">
                    <div class="form-group" style="margin-bottom:var(--space-3)">
                        <label class="form-label">Pregunta <span class="required">*</span></label>
                        <input type="text" class="form-input faq-pregunta-input" placeholder="Escriba la pregunta..." maxlength="1000">
...
<script>window.FAQ_UUID = <?php echo json_encode($editUuid); ?>;</script>
