...
<body>
    <div class="app-layout" id="app-layout">
        ...
        <main class="main-content">
            ...
            <div id="page-loading" style="padding:var(--space-12);text-align:center;color:var(--color-text-secondary)">
                <div class="spinner" style="margin:0 auto 12px;border-color:rgba(255,255,255,0.15);border-top-color:var(--color-accent)"></div>
                Cargando producto...
            </div>
                        ...
                        <div class="tab-panel card" id="form-tab-general">
                            ...
                            <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="prod-descripcion" class="form-input" rows="5" maxlength="5000" style="height:auto;padding-top:10px;padding-bottom:10px;resize:vertical"></textarea>
                                </div>
                            </div>
                        </div>
