...
<body>
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="page-header-left">
                    ...
                    <p class="page-subtitle">Modifique los datos del producto y sus variantes</p>
                </div>
                <a href="productos.php" class="btn btn-secondary">← Volver</a>
            </div>

            <div id="page-loading" class="text-center" style="padding:var(--space-8)">Cargando producto...</div>

            <form id="producto-form" novalidate style="display:none">
                <input type="hidden" id="prod-uuid" value="<?= htmlspecialchars($uuid) ?>">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="variantes-list" style="display:flex;flex-direction:column;gap:var(--space-5)">
                                    <p class="text-muted text-sm" id="variantes-empty">No hay variantes.</p>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                                ...
                                <div id="atributos-valores-wrap"
                                    style="display:none;flex-direction:column;gap:var(--space-3)"></div>
                            </div>
                        </div>
    ...
    <template id="tpl-variante">
        <div class="variante-card" data-idx="" data-uuid="">
    ...
    <!-- Modales de gestión inline (idénticos al de create) -->
            ...
            <div class="modal-body">
                <form id="color-quick-form" novalidate style="display:flex;flex-direction:column;gap:var(--space-4)">
                    ...
                    <div style="display:flex;gap:var(--space-3)">
                        <button type="submit" class="btn btn-primary"><span class="spinner"></span><span
                                class="btn-text">Guardar</span></button>
