...
<body>
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="page-header-left">
                    ...
                    <p class="page-subtitle">Modifique los datos de la categoría</p>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-4)">
                            <div class="form-group">
                                ...
                                <input type="text" id="cat-nombre" class="form-input" maxlength="255" required>
                                <span class="form-error" id="cat-nombre-error"></span>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="cat-orden">Orden</label>
                                <input type="number" id="cat-orden" class="form-input" min="0" step="1">
                            </div>
                            <div class="form-group">
    ...
    <script>window.CATEGORIA_UUID = '<?php echo htmlspecialchars($editUuid, ENT_QUOTES, 'UTF-8'); ?>';</script>
