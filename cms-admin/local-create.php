...
<body>
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="page-header-left">
                    <h2 class="page-title">Nuevo Local</h2>
                    <p class="page-subtitle">Complete el formulario para crear un nuevo local</p>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="local-form-submit">
                                    <span class="spinner"></span><span class="btn-text">Crear Local</span>
                                </button>
                            </div>
                        </div>
    ...
    <script>window.LOCAL_UUID = null;</script>
